        ...
        <section className="purchase-content pc-01">
            <div className="inner">
                ...
                <div className="site-link flex-center">
                    ...
                    <a href="https://gmsc.co.kr/" target="_blank" rel="noopener noreferrer">
                        <img src="/images/logo_gmsc.svg" alt="굿모닝셀카 바로가기"></img>
                        내차팔기 비교 견적
                    </a>
                </div>
            </div>
            ...
            <div className="inner">
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <div className="fc-g-2">
                            합리적인 가격과 맞춤형 금융 프로그램을 통해 보다 부담 없이 차량을 구매하실 수 있도록 도와드립니다.
                        </div>
                        <img className="img-responsive" src="/images/purchase_img_06.png" alt="매입 이미지 6"></img>
                    </li>
                </ol>
            </div>
            ...
            <div className="inner">
                <div className="tit-box">
                    ...
                    <div>
                        ...
                        믿을 수 있는 중고차 거래와 고객님의 만족을 위해 최선을 다하겠습니다.
                    </div>
                </div>
            </div>
        </section>
