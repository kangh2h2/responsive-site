...
const useAboutScrollEffect = () => {
  useLayoutEffect(() => {
    // 기존 트리거 제거
    ScrollTrigger.getAll().forEach(t => t.kill());

    const sectionsToPin = document.querySelectorAll(".about-content.content");
...
const About = () => {
  ...
  return (
    <>
      ...
      <section className="about-content content ac-03 company txt-center">
        <div className="inner">
          <h1 className="ani-up">
            우리는 신차 구매부터<br />
      ...
      <section className="about-content content ac-04" >
      ...
      <section className="about-content ac-05">
        <div className="inner">
          <h3 className="fc-s ani-up">A New Standard</h3>
          <h1>
            <div className="fc-m ani-hidden"><span className="ani-up">우리는 단순히</span></div>
            <div className="ani-hidden"><span className="ani-up">차량을 유통하는 기업이 아닌,</span></div>
          </h1>
